...
router.get('/:artistId', (req, res) => {
    const statement = db.prepare('select Name from artists where ArtistId=?') //get all data from employees table
    const data = statement.get(req.params.artistId); //get me all the data in an array
    res.json(data)
})
